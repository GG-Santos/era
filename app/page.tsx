  ...
  return (
    <div className="grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-4 pb-10 gap-8 sm:p-10 font-[family-name:var(--font-geist-sans)]">
      <main className="flex flex-col gap-6 row-start-2 items-center sm:items-start">
        ...
        <h1>Database Under Maintenance</h1>
        <h2>We apologize for the inconvenience.</h2>
        <h3>This maintenance is due to the implementation of new COBRA and ISCM License Number encoding.</h3>
        <h3>In the meantime, to verify LCNs, please contact us at:</h3>
        <a href="mailto:eraqrt.validation@proton.me">
          eraqrt.validation@proton.me
        </a>
      </main>
      <footer>ERA-QRT Validation © 2024. All rights reserved.</footer>
    </div>
  );
}
